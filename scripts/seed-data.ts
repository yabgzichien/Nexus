...
async function seed() {
  ...
  const mentors = [
    {
      ...
      data: {
        ...
        description: "Former CTO of GrabPay. 12 years building payment infrastructure across Southeast Asia. Passionate about helping fintech startups navigate regulatory complexity.",
        industry: "Fintech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Serial healthtech entrepreneur. Founded MedikAI (acquired 2022). Deep expertise in AI/ML for healthcare and navigating PDPA/health data regulations.",
        industry: "HealthTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "VP Product at Carsome. Expert in marketplace dynamics, growth hacking, and Southeast Asian consumer behaviour. MBA from INSEAD.",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Angel investor and former Sequoia scout for SEA. Invested in 20+ startups. Specialises in deep tech and B2B SaaS business models.",
        industry: "Deep Tech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Sustainability tech pioneer. Co-founded GreenChain (carbon marketplace). Expert in ESG compliance, climate tech, and impact measurement.",
        industry: "CleanTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "EdTech entrepreneur. Founded LearnLab (Series B). Expert in education technology, gamification, and user engagement strategies.",
        industry: "EdTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Supply chain expert. Former VP at DHL Malaysia. Specializes in logistics optimization, warehouse automation, and last-mile delivery solutions.",
        industry: "Logistics",
    ...
    },
    {
      ...
      data: {
        ...
        description: "FoodTech innovator. Co-founded FoodChain (acquired 2023). Expert in food delivery platforms, restaurant tech, and supply chain management.",
        industry: "FoodTech",
  ...
  const startups = [
    {
      ...
      data: {
        ...
        description: "Building instant cross-border payment rails for SME exporters in ASEAN. Currently processing RM 2M monthly in pilot.",
        industry: "Fintech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "AI-powered diagnostic imaging for rural clinics. Our model detects 12 conditions from chest X-rays with 94% accuracy, deployable on edge devices.",
        industry: "HealthTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Automated ESG reporting and carbon credit marketplace for Malaysian manufacturers. Making compliance simple and turning sustainability into revenue.",
        industry: "CleanTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Personalized learning platform using AI to adapt content difficulty based on student performance. Used by 50+ schools in Klang Valley.",
        industry: "EdTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "AI-powered logistics optimization platform for SMEs. Reduces delivery costs by 30% through smart route planning and warehouse allocation.",
        industry: "Logistics",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Farm-to-table marketplace connecting local farmers directly with restaurants. Fresh produce delivered within 24 hours of harvest.",
        industry: "FoodTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "AI-powered patient triage system for emergency departments. Reduces wait times by 45% and improves diagnosis accuracy.",
        industry: "HealthTech",
    ...
    },
    {
      ...
      data: {
        ...
        description: "Solar panel installation and management platform for residential properties. AI-powered energy optimization reduces bills by 50%.",
        industry: "CleanTech",
  ...
  const admin = {
    ...
    data: {
      ...
      description: "Cradle Fund programme administrator",
